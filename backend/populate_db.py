...
from app import db, Lecturer, Room, Course, TimeSlot
...
courses = [
    Course(
        id=f"PHY{random.randint(100,199)}",
    ...
    for _ in range(15)  # 50 courses
]

db.session.bulk_save_objects(courses)
db.session.commit()
print("✅ 50 Courses Added")
